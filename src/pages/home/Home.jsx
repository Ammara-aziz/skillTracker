    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main>
        <section className="relative overflow-hidden">
          ...
          <div className="absolute left-1/2 top-0 -z-10 h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-indigo-100/50 blur-3xl" />
        ...
        {/* CTA */}
        <section className="px-6 pb-24 lg:px-8">
          <div className="mx-auto max-w-6xl overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 to-violet-600 px-6 py-14 text-center text-white sm:px-12">
